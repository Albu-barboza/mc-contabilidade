  ...
  return (
    <>
      ...
      <div className="">
        <section className="pt-28 pb-16 sm:pt-32 sm:pb-20">
          <div className="container mx-auto px-4 sm:px-6 text-center space-y-4">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-slate-200 max-w-3xl mx-auto">
              Estamos orgulhosos da confiança que nossos clientes depositam em nós. Veja como nossa parceria tem gerado
        ...
        <Section
          title="Quer ser nosso próximo caso de sucesso?"
          sectionClassName="!py-16 sm:!py-24"
          containerClassName="!px-4 sm:!px-6 text-center max-w-3xl space-y-6"
          headerWrapper={() => (
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-slate-50">
                Quer ser nosso próximo caso de sucesso?
              </h2>
              <p className="text-base sm:text-lg text-gray-600 dark:text-slate-200">
                Nossa equipe está pronta para te ajudar a crescer com segurança e eficiência. Fale conosco e solicite
                uma proposta sem compromisso.
              </p>
            </div>
          )}
        >
          <Button onClick={openForm} variant="primary" size="lg" className="w-full sm:w-auto px-10 py-4 text-lg">
